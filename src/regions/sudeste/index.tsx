...
import fabioVianaPhoto from "./assets/speakers/fabio-viana.jpg";
...
import isacaLogo from "./assets/sponsors/isaca.jpeg";
...
const speakerPhotoMap: Record<string, string> = {
  ...
  "fabio-viana.jpg": fabioVianaPhoto
};
